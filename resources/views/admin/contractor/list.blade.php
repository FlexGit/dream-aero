...
<tr class="odd" data-id="{{ $contractor->id }}">
	...
	<td class="align-middle d-none d-lg-table-cell">
		<div class="col-12 text-nowrap">
			...
			<div class="col-12 text-nowrap">
				<small>[<a href="javascript:void(0)" data-toggle="modal" data-url="/contractor/{{ $contractor->id }}/score" data-action="/contractor/{{ $contractor->id }}/score" data-method="POST" data-type="score" data-title="Добавление баллов и времени налета" title="Добавить баллы и время налета">добавить баллы и время налёта</a>]</small>
			</div>
		</div>
	</td>
