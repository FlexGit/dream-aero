...
<tr class="odd">
	...
	<td class="align-middle">{{ $contractor->email }}</td>
	<td class="text-right align-middle">{{ $contractor->phone }}</td>
	<td class="align-middle">{{ $contractor->city->name ?? '' }}</td>
	<td class="text-right align-middle">{{ number_format($contractor->discount, 0, '.', ' ') }}</td>
	<td class="text-center align-middle">{{ $contractor->is_active ? 'Да' : 'Нет' }}</td>
	<td class="text-center align-middle">{{ $contractor->last_auth_at }}</td>
	{{--<td class="text-center align-middle">{{ $contractor->created_at }}</td>
	<td class="text-center align-middle">{{ $contractor->updated_at }}</td>--}}
