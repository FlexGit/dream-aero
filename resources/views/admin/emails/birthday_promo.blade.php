							...
							<tr>
								...
								<td colspan="3" rowspan="3" bgcolor="#FFFFFF" style="padding:10px 0 30px;text-align:center">
									...
									<p style="margin:15px 30px 33px;text-align:left;font-size:14px;line-height:30px;color:#484a42;">
										В преддверии Вашего Дня Рождения мы рады напомнить, что у Вас есть возможность воспользоваться скидкой {{ ($promo->discount->valueFormatted() ?? '') }} на полет в Авиатренажере. <a href="https://dream-aero.ru/{{ $city ? $city->alias : 'msk' }}/price?utm_source=dreamaero&utm_medium=email&utm_campaign=birthday_promo" style="color:#ffffff;font:bold 16px 'arial' , 'helvetica neue' , 'helvetica' , sans-serif;text-decoration:none" target="_blank" rel="noopener noreferrer">Подробнее</a>.
										<br>
									</p>
