					...
					<td>
						<table cellpadding="0" cellspacing="0" border="0" width="90%" style="max-width:600px;margin:0 auto">
							...
							<tr>
								...
								<th colspan="3" rowspan="3" bgcolor="#FFFFFF" style="padding:10px 0 30px;text-align:center">
									...
									<p style="margin:15px 30px 33px;text-align:left;font-size:14px;line-height:30px;color:#484a42;">
										Поздравляем с наступающим Днем Рождения! Спешим напомнить, что с сегодняшнего дня и до {{ \Carbon\Carbon::parse($contractor->birthdate)->addDays(3)->format('d.m.Y') }} у вас есть возможность забронировать полет со скидкой {{ ($promo->discount->valueFormatted() ?? '') }} в честь праздника.
										<br><br>
									...
									<table bgcolor="#ffffff" border="0" cellpadding="0" cellspacing="0" width="100%" style="background-color:#fff;border-bottom-left-radius:0;border-bottom-right-radius:0;border-collapse:collapse;border-color:transparent;border-top-left-radius:0;border-top-right-radius:0;font-size:16px;line-height:1.5;margin-bottom:0 !important"><tbody><tr style="border-color:transparent"><td style="border-collapse:collapse;border-color:transparent"><div style="font-size:16px;line-height:1.5;padding:15px"><hr style="border-style:solid none none none;border-top-color:#b2b2b2;border-width:1px 0 0 0;margin:0"></div></td></tr></tbody></table>
									<table border="0" cellpadding="0" cellspacing="0" width="100%" style="border-collapse:collapse;border-color:transparent;font-size:16px;line-height:1.5;margin-bottom:0 !important;width:100%"><tbody><tr style="border-color:transparent"><th align="left" valign="top" width="600" style="border-color:transparent;font-weight:400;text-align:left;vertical-align:top"><table bgcolor="#ffffff" border="0" cellpadding="0" cellspacing="0" width="100%" style="background-color:#fff;border-bottom-left-radius:0;border-bottom-right-radius:0;border-collapse:collapse;border-color:transparent;border-top-left-radius:0;border-top-right-radius:0;font-size:16px;line-height:1.5;margin-bottom:0 !important"><tbody><tr style="border-color:transparent"><td style="border-collapse:collapse;border-color:transparent"><table cellpadding="0" cellspacing="0" width="100%" style="border-collapse:separate;border-color:transparent;font-size:16px;line-height:1.5;margin-bottom:0 !important;overflow:hidden"><tbody><tr style="border-color:transparent;color:#363333;font-family:'tahoma' , 'geneva' , sans-serif"><td valign="top" width="570" style="border-collapse:collapse;border-color:transparent;padding:15px;vertical-align:top;word-break:break-word"><div align="center" style="box-sizing:border-box;font-size:16px;height:365;line-height:1.5;text-align:center;width:100%"><img src="https://dream-aero.ru/assets/img/email/birthday.jpg" alt="" style="max-width:100%"></div></td></tr></tbody></table></td></tr></tbody></table></th></tr></tbody></table>
