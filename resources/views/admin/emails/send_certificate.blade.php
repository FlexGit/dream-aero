									...
									<table cellpadding="0" cellspacing="0" border="0" width="100%">
										...
										<tr valign="top">
											...
											<td style="text-align:left;">
												...
												<p style="margin:0;color:#333333;font-size:11px;line-height:18px;">наш администратор готов ответить на них.<br>Позвоните <a target="_blank" rel=" noopener noreferrer"><span class="js-phone-number">{{ $city->phone ?? '' }}</span></a> или <a target="_blank" rel=" noopener noreferrer">напишите {{ $city->email ?? '' }}</a>
												</p>
												<p style="margin:0;font-size:1px;line-height:1px;">&nbsp;</p>
												<a href="https://t.me/dreamaero" target="_block" rel="noopener noreferrer">
													<img src="{{ asset('img/telegram.png') }}" width="24" height="24" alt="telegram" style="display:block;margin:0;border:0;">
												</a>
