				...
				<div class="card-body">
					<div class="table-filter d-sm-flex">
						<div class="form-group align-self-end text-right ml-auto">
							<a href="javascript:void(0)" data-toggle="modal" data-url="/employee/add" data-action="/employee" data-method="POST" data-title="Добавление" class="btn btn-secondary btn-sm" title="Добавить">Добавить</a>
						</div>
					</div>
					<table id="employeeTable" class="table table-hover table-sm table-bordered table-striped table-data table-no-filter">
						<thead>
						<tr>
							<th class="text-center">Имя</th>
							<th class="text-center d-none d-sm-table-cell">Должность</th>
...
@section('js')
	...
	<script>
		$(function() {
			function getList() {
				var $selector = $('#employeeTable tbody');
