			...
			<div class="card">
				<div class="card-body">
					<div class="d-flex justify-content-between mb-2">
						...
						<a href="javascript:void(0)" data-toggle="modal" data-url="/flight_simulator_type/add" data-action="/flight_simulator_type" data-method="POST" data-title="Добавление" class="btn btn-secondary btn-sm" title="Добавить запись">Добавить</a>
					</div>
					<table id="flightSimulatorTypeTable" class="table table-hover table-sm table-bordered table-striped">
						<thead>
						<tr>
...
@section('js')
	...
	<script>
		$(function() {
			function getList(url) {
				$.ajax({
					...
					success: function(result) {
						...
						$('#flightSimulatorTypeTable tbody').html(result.html);
					}
				})
			}

			getList('{{ route('flightSimulatorTypeList') }}');
			...
			$(document).on('submit', '#flightSimulatorType', function(e) {
				e.preventDefault();
