...
<tr class="odd">
	...
	<td class="text-center d-none d-sm-table-cell">{{ $tariffType->is_active ? 'Да' : 'Нет' }}</td>
	<td class="text-center d-none d-xl-table-cell">{{ $tariffType->created_at }}</td>
	<td class="text-center d-none d-xl-table-cell">{{ $tariffType->updated_at }}</td>
