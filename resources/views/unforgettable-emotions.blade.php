...
@section('content')
	<div class="breadcrumbs container"><a href="{{ url(Request::get('cityAlias') ?? '/') }}">@lang('main.home.title')</a> <span>@lang('main.unforgettable-emotions.title')</span></div>

	<div class="about simul" id="about">
		<div class="container">
			<h1 class="block-title">@lang('main.unforgettable-emotions.title')</h1>
			<div class="text-block wow fadeInRight simul" data-wow-delay="0.5s" data-wow-duration="2s" style="visibility: visible; animation-duration: 2s; animation-delay: 0.5s; animation-name: fadeInRight;">
				@lang('main.unforgettable-emotions.preview')
			</div>
		</div>
		...
		<div class="container">
			...
			<div class="about-simulator">
				<div class="about-simulator">
					@lang('main.unforgettable-emotions.text')
				</div>
			</div>
		</div>
	</div>
