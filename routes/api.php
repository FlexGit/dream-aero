...
Route::domain(env('DOMAIN_ADMIN', 'admin.dream-aero.ru'))->group(function () {
	Route::group(['middleware' => [/*'throttle:30,1', */'apikey'/*, 'apilog'*/]], function () {
		...
		Route::get('v2/tariff/price', [ApiController::class, 'getTariffPriceV2']);
		Route::get('v3/tariff/price', [ApiController::class, 'getTariffPriceV3']);
		...
		Route::post('v2/deal/create', [ApiController::class, 'createDealV2']);
